	...
	<div class="personal">
			...
			<div class="beforeLoan">
				...
				<ul class = "loan_list">
					...
					<li>
						<img src="src/assets/imgs/personal_14.png">
						<span>消费行为</span>
					</li>
					<li>
						<img src="src/assets/imgs/personal_16.png">
						<span>稳定性</span>
					</li>
					<li>
						<img src="src/assets/imgs/personal_18.png">
						<span>终端属性</span>
					</li>
					<li>
						<img src="src/assets/imgs/personal_20.png">
						<span>朋友圈</span>
					</li>
					<li>
						<img src="src/assets/imgs/personal_09.png">
						<span>号码属性</span>
					</li>
				</ul>
			</div>
			...
			<div class="afterLoan">
				<h3>贷后跟踪</h3>
				<p>贷后催收最大的难题是贷款用户失联，无法触达用户。立趣贷后跟踪模型，借助多样你给的数据源和业务规则，可建立针对个人用户的失联跟踪模型，识别个人用户可能的新的联系方式，从而降低催收成本，减少损失。</p>
				<div class="loanFlow">
