<template>
	<div class="contact">
		...
		<div class="contact_msg">
			<el-card shadow="always" class = "wow slideInLeft">
			...
			<el-card shadow="always" class = "wow slideInDown">
			...
			<el-card shadow="always" class = "wow slideInRight">
				<img src="../../assets/imgs/contact_09.png">
				<h3>邮箱地址</h3>
				<div class="contact_detail">
					contact@lychee-info.cn
				</div>
				<button style = "background: #49cdd9">Malbox</button>
			</el-card>
		</div>
		<div class="contact_map">
			<img class = "wow slideInUp" src="../../assets/imgs/contact_15.png">
		</div>
	</div>
</template>
<script>
